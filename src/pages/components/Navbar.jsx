    ...
    return (
        <nav className="py-2 mb-0 flex justify-between fixed top-0 w-full z-50 bg-white  dark:bg-gradient-to-r from-[#404040] to-[#181818]">
            ...
            <ul className="flex items-center mt-0 gap-2 md:gap-6">
              ...
              <li><a href="https://drive.google.com/file/d/1uHhbadXBclSxUZpwjGNkyhMdnOnD_h9u/view?usp=sharing" target="_blank" className="text-xl bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 mr-8 py-2 rounded-md">Resume</a></li>
            </ul>
          </nav>
    );
}
