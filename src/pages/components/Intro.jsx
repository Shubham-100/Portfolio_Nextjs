...
const Intro = ({darkMode}) => {
    return (
        <div className="dark:text-white mx-auto md:shadow-2xl md:rounded-2xl md:max-w-xl">
              ...
              {
                darkMode ? <div>
                  <img alt="Night Coding" src="https://raw.githubusercontent.com/AVS1508/AVS1508/master/assets/Night-Coding.gif" className="mx-auto pb-5 w-80 h-64 md:w-96 md:h-80"/></div>
                  :
                  <div className="p-5 relative bg-gradient-to-b from-cyan-500 to-teal-500 rounded-full w-80 h-80 mx-auto overflow-hidden mt-0 md:w-96 md:h-96">
