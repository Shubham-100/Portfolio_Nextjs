...
Users can search for content of their preference based on genre</p>
            ...
            <div className="flex flex-col flex-wrap gap-8  py-0 text-black  dark:text-white">
              {/* <img src="net.png" width="100%" height="100%" className="mx-auto border-solid border-black dark:border-white border-4 hover:border-solid" /> */}
              <Image src="/net.png" width={600} height={300} className="mx-auto border-solid border-black dark:border-white border-4 hover:border-solid overflow-hidden mt-0 md:w-96 md:h-64"/>
              <ul className="flex flex-row items-center justify-center gap-4">
