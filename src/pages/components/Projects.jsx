        ...
        <div className="px-10 py-5 mt-0 mx-auto md:shadow-2xl md:rounded-2xl md:max-w-xl">
          ...
          <h5 className="text-2xl font-medium py-5 text-center text-black dark:text-white ">Movies Recommendation App</h5>
            <div className="flex flex-col flex-wrap gap-8  py-0 text-black  dark:text-white">
              <Image src="/netflix.png" priority={false} alt="project" width={600} height={250} className="object-cover mx-auto border-solid border-black dark:border-white border-4 hover:border-solid overflow-hidden mt-0 md:w-96 md:h-64"/>
              {/* <img src="../../../public/netflix.png" className="object-cover mx-auto border-solid border-black dark:border-white border-4 hover:border-solid overflow-hidden mt-0 md:w-96 md:h-64"/> */}
            ...
            <div className="flex flex-col flex-wrap gap-8  py-0 text-black  dark:text-white">
              <Image src="/ytm.jpg" priority={false} alt="project" width={600} height={250} className="object-cover mx-auto border-solid border-black dark:border-white border-4 hover:border-solid overflow-hidden mt-0 md:w-96 md:h-64"/>
              <ul className="flex flex-row items-center justify-center gap-4">
